...
写出过程按 raster block 恢复水深，不创建另一张全窗口水深工作数组，并在完整
COG 通过结构和对齐检查后原子发布。COG tags 包含质量平衡、最大水深、湿区面积，
以及 `0.05、0.15、0.30、0.50、1.00 m` 阈值影响面积。
...
- 不模拟雨型、初损或入渗过程、动量、流速、洪峰传播、动态潮位回水、桥涵、
  管网、动态排水或建筑阻水。
